...
Repo này là **trang phát hành**: chỉ chứa tài liệu và các bản cài (mục
[Releases](https://github.com/tnqaquocanh-vn/theisle-overlay/releases)). Mã
nguồn được phát triển ở kho riêng của BumBum.

Giấy phép **MIT** (xem [`LICENSE`](LICENSE)) — bạn được phép fork, chỉnh sửa và
tự build từ ảnh chụp mã đã công bố trước đây; chỉ cần giữ lại thông báo bản
quyền và phần ghi công ở [`THIRD-PARTY-NOTICES.md`](THIRD-PARTY-NOTICES.md).
Báo lỗi / góp ý qua [GitHub Issues](https://github.com/tnqaquocanh-vn/theisle-overlay/issues).
