...
// NOTE: this list is full — 18 slots + 2 reserved doubles = the 20-double
// data-point cap enforced in worker/src/features.ts. A new feature counter
// needs a data-point format bump, not another slot.
